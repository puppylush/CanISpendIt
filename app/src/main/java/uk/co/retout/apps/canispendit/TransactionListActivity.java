 ...
 * {@link TransactionListFragment} and the item details
 * (if present) is a {@link TransactionDetailFragment}.
 * <p/>
 * This activity also implements the required
 * {@link TransactionListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class TransactionListActivity extends FragmentActivity
        implements TransactionListFragment.Callbacks {
